...
if(isset($_POST["submit"])){
    ...
    $query = "UPDATE `users` SET username = '$username', email = '$email', first_name = '$f_name', last_name = '$l_name', password = '$password' Where id = $id ";
    $result = mysqli_query($con, $query);
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <label class="mb-1" for="inputFirstName">Username</label>
